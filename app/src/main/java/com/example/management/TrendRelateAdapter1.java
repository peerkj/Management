...
public class TrendRelateAdapter1 extends RecyclerView.Adapter<TrendRelateAdapter1.ViewHolder> {

    //데이터 배열 선언
    private ArrayList<TrendRelateObject1> mList;
    private Context mContext;

    public TrendRelateAdapter1(Context context, ArrayList<TrendRelateObject1> list) {
        this.mList = list;
        this.mContext = context;
    }

    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView textView_who, textView_headline;
    ...
    @NonNull
    @Override
    public TrendRelateAdapter1.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.trend_news_data, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final TrendRelateAdapter1.ViewHolder holder, final int position) {
        ...
        final String relate = String.valueOf(mList.get(position).getWho());
